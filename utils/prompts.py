...
Based on the conversation history of multiple users, the created search query, and the list of places returned, create a justification for the results in a casual narrative format.
The justification should be based on the RESULTS not the search query.
